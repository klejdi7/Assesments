...
final class MimeTypes implements MimeTypesInterface
{
    ...
    private const MAP = [
        ...
        'application/vnd.adobe.flash.post' => ['swf', 'spl'],
    ...
    private const REVERSE_MAP = [
        ...
        'spl' => ['application/futuresplash', 'application/vnd.adobe.flash.post', 'application/x-futuresplash', 'application/x-shockwave-flash'],
        ...
        'swf' => ['application/futuresplash', 'application/vnd.adobe.flash.post', 'application/x-shockwave-flash'],
